                                ...
                                <div className="space-y-6 relative">
                                    ...
                                    <div className="relative flex flex-col md:flex-row gap-6 group">
                                        ...
                                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all flex-1">
                                            ...
                                            <p className="text-slate-500 text-lg leading-relaxed mb-4">
                                                prepare learners for a final writing task and activate, review or build sub-skills that prepare the learner for completing the main writing task. They usually focus on the audience, the content, and the vocabulary necessary for the task. These are typically word and phrase level activities.
                                            </p>
                                    ...
                                    <div className="relative flex flex-col md:flex-row gap-6 group">
                                        ...
                                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all flex-1 border-l-4 border-l-purple-500">
                                            ...
                                            <p className="text-slate-500 text-lg leading-relaxed mb-4">
                                               engage learners in recursive writing, self-editing and revisions. As the students are guided through writing and re-writing, the teacher should guide them through other areas such as syntax.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex flex-col md:flex-row gap-6 group">
                                        ...
                                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all flex-1">
                                            ...
                                            <p className="text-slate-500 text-lg leading-relaxed">
                                                help learners reflect on and revise their writing based on feedback from an audience, such as peers and/or an instructor.
                                            </p>
                                        </div>
                                    </div>
                                </div>
